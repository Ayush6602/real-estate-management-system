...
class SearchUi(tk.Canvas):
    def __init__(self, master, db_connection: DBConnection) -> None:
        ...
        self.bathroom_select = tk.Entry(self, validate='all', validatecommand=(vcmd,'%P'))
        self.locality_select = tk.Entry(self)
        self.bedroom_select = tk.Entry(self, validate='all', validatecommand=(vcmd,'%P'))
        self.kitchen_select = tk.Entry(self, validate='all', validatecommand=(vcmd,'%P'))
        self.hall_select = tk.Entry(self, validate='all', validatecommand=(vcmd,'%P'))
        self.price_select = tk.Entry(self, validate='all', validatecommand=(vcmd,'%P'))
        self.status_select = tk.Entry(self)
        self.rent_select = tk.Entry(self, validate='all', validatecommand=(vcmd,'%P'))
        self.type_select = tk.Entry(self)
        self.size_select = tk.Entry(self, validate='all', validatecommand=(vcmd,'%P'))
    ...
    def render(self, event: tk.Event = None) -> None:
        ...
        self.create_window(2*width//7, 2*height//20 + 5, anchor="nw", window=self.local_select)
    ...
    def make_treeview(self, event=None):
        ...
        height = self.winfo_height()
        width = self.winfo_width()
        self.create_window(10, 12*height//20, anchor="nw",
