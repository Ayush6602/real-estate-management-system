...
class AddModifyProperty(tk.Canvas):
    ...
    def render(self, event: tk.Event = None) -> None:
        ...
        self.create_text(10, 10, text="Enter property id:", anchor = "nw", font=('arial', 20, 'bold'), fill="yellow")
